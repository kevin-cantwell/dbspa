...
100K records on Apple M4:

| Scenario | Throughput |
|---|---|
| NDJSON passthrough | 276K/sec |
| Parquet filter (DuckDB) | 1.96M/sec |
| CDC + DD join + 7 aggregates (JSON) | 101K/sec |
| CDC + DD join + 7 aggregates (Avro) | 114K/sec |
